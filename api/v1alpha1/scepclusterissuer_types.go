...
type SCEPClusterIssuerList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []SCEPClusterIssuer `json:"items"`
}

func init() {
	SchemeBuilder.Register(&SCEPClusterIssuer{}, &SCEPClusterIssuerList{})
}
